...
const categories = [
  ...
  },
  {
    ...
    modules: [
      ...
      {
        name: 'Builder & AMC Management',
        description: 'Manage builder handover, AMC contracts, and warranty tracking for newly constructed societies.',
        capabilities: ['Builder defect tracking', 'AMC contract management', 'Warranty expiry alerts', 'Handover checklists'],
        platforms: ['web', 'api'],
      },
      {
        name: 'Package & Add-On Management',
        description: 'Configure subscription packages and optional add-ons for flexible society plans.',
        capabilities: ['Custom plan packages', 'Add-on marketplace', 'Usage-based billing', 'Feature toggle per plan'],
        platforms: ['web', 'api'],
      },
      {
        name: 'Installment Plans',
        description: 'Support flexible payment schedules for large maintenance bills and special levies.',
        capabilities: ['Custom installment schedules', 'Auto-reminders for due dates', 'Partial payment tracking', 'Late fee configuration'],
        platforms: ['web', 'api'],
      },
      {
        name: 'GDPR & Data Compliance',
        description: 'Data privacy controls and compliance tools for resident data management.',
        capabilities: ['Data export & erasure requests', 'Consent management', 'Audit trail for data access', 'Privacy policy enforcement'],
        platforms: ['web', 'api'],
      },
      {
        name: 'Developer APIs',
        description: 'RESTful APIs for third-party integrations, custom dashboards, and automation workflows.',
        capabilities: ['Comprehensive REST API', 'Webhook support', 'API key management', 'Rate limiting & quotas'],
        platforms: ['api'],
      },
    ],
  },
